...
_commander2.default.version((0, _version.version)()).arguments('<blueprint> [entity name]').option('-v, --verbose', 'Turn debug mode on').description('generates code based off a blueprint').action(function (blueprintName, entityName, command) {
